module movecraft::plank {

    const NAME: vector<u8> = b"Plank";
    const DESCRIPTION: vector<u8> = b"MoveCraft plank Block";
    ...
    const URI: vector<u8> = b"https://relive.noncegeek.com/assets/plank.svg";
    const BLOCK_TYPE: u64 = 1;
